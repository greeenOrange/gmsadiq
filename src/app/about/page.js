      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <defs>
          ...
          <mask id="text-mask">
            ...
            <text x="50%" y="20%" dominantBaseline="middle" textAnchor="middle" fill="url(#text-gradient)" fontSize="24" font-family="Arial" font-weight="bold">Based in Bangladesh</text>
          </mask>
        </defs>
